...
async function groqChatJSON(messages, opts = {}, requiredKeys = []) {
  ...
  try {
    ...
    // Inject a stern reminder as an additional system-style user turn
    const strictMessages = [
      ...messages,
      {
        role: 'assistant',
        content: '{'  // prime the model to start with {
      }
    ];

    // Some Groq models support priming via the assistant role; others need a reminder
